...
|命令|格式|别名|描述|权限|
|-----|-----|-----|-----|-----|
|`+邀请列表`|`+邀请列表`|`-`|`查看当前待处理的邀请列表。`|`10`|
|`+同意申请`|`+同意申请 <群号>`|`+同意邀请 <群号>`|`同意某一个群聊的邀请。`|`10`|
|`+拒绝申请`|`+拒绝申请 <群号>`|`+拒绝邀请 <群号>`|`拒绝某一个群聊的邀请。`|`10`|
...
|命令|格式|别名|描述|权限|
|-----|-----|-----|-----|-----|
|`+投掷漂流瓶`|`+投掷漂流瓶 <内容> [是否匿名(默认否)]`|`-`|`投掷一个漂流瓶到池塘。`|`-`|

### 收回漂流瓶

|命令|格式|别名|描述|权限|
|-----|-----|-----|-----|-----|
|`+收回漂流瓶`|`+收回漂流瓶 <瓶ID>`|`-`|`从池塘收回一个漂流瓶。`|`-`|
...
|命令|格式|别名|描述|权限|
|-----|-----|-----|-----|-----|
|`+举报漂流瓶`|`+举报漂流瓶 <瓶ID>`|`-`|`举报一个打捞得到的漂流瓶。`|`-`|

### 查看漂流瓶

|命令|格式|别名|描述|权限|
|-----|-----|-----|-----|-----|
|`+查看漂流瓶`|`+查看漂流瓶 <瓶ID>`|`-`|`查看某漂流瓶的实际内容。`|`10`|
...
!> `v2`的界面以及素材均来自于`JX3BOX`，但是原理**完全不一致**，`JX3BOT`使用`canvas`画布进行绘制，而音卡使用`PIL`手动测绘坐标进行绘制！
...
|`+jx3_zone_detail`|`+jx3_zone_detail <服务器> <ID>`|`+副本总览`|`获取个人副本总览概况。`|`9`|[示例](https://inkar-suki.codethink.cn/Inkar-Suki-Docs/img/examples/jx3_detail.png)/[图例](https://inkar-suki.codethink.cn/Inkar-Suki-Docs/img/examples/jx3_detail_response.png)|
...
|命令|格式|别名|描述|权限|
|-----|-----|-----|-----|-----|
|`+增加金币`|`+增加金币 <QQ号> <增加量>`|`-`|`向某用户的账户增加金币。`|`-`|
|`+减少金币`|`+减少金币 <QQ号> <减少量>`|`-`|`向某用户的账户减少金币。`|`-`|
